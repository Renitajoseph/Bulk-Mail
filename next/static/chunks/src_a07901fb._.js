...
_s(AuthProvider, "NhYvoQDLzDB3EHbaipW1LlW1sPE=");
_c = AuthProvider;
function useAuth() {
    _s1();
...
function Header() {
    ...
    const { isAuthenticated, logout } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$auth$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
...
_s(Header, "KKnM2cndNRZtdXBfAm8wWFsmeSY=", false, function() {
    return [
...
//# sourceMappingURL=src_a07901fb._.js.map